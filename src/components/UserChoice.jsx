...
import { fetchedQuizData } from '../features/quizz/quizzSlice'

const UserChoice = ({ onStart }) => {
    const { formData, setFormData, quizData, data, loading, setLoading } = useContext(quizDataContext)
            ...
            <form className='w-full py-6' onSubmit={handleSubmit}>
                ...
                <div className=' flex justify-center items-center p-3'>
                    <button type='submit' className=' px-6 py-3 cursor-pointer text-white text-lg font-semibold bg-orange-500 rounded-2xl'>
                        {
                            loading ? <span className='text-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-center dark:focus:ring-blue-800 inline-flex items-center'>
